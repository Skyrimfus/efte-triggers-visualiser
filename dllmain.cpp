...
#define M// dllmain.cpp : Defines the entry point for the DLL appli// dllmain.cpp : Defines the entry point for the DLL application.
#include "pch.h"
#include <iostream>
#include <d3d9.h>
#include <d3dx9.h>
...
unsigned int __stdcall hookedLoopTop(int a1, int a2, int a3) {//a3 is what we need
    ...
    vec3 playerpos = {0, 0, 0};
    if (*(int*)0x60978CE0 && **(int**)0x60978CE0) {
        float* playerpos_tmp = (float*)((**(int**)0x60978CE0) + 0x228);
